    ...
    <div class="container">
        <div class="row g-4">
            <div class="col-lg-5 col-md-12">
                <h6>Shoe<span style="color:#dc2626">Shop</span></h6>
                <p class="mb-0">Cửa hàng quần áo – giày dép trực tuyến. Tuyển chọn giày sneaker, giày tây,
                    áo thun, quần jean chính hãng — giá tốt mỗi ngày.</p>
            </div>
            <div class="col-lg-3 col-6">
                <h6>Khám phá</h6>
                <div><a href="${pageContext.request.contextPath}/home">Trang chủ</a></div>
                <div><a href="${pageContext.request.contextPath}/wishlist">Sản phẩm yêu thích</a></div>
                <div><a href="${pageContext.request.contextPath}/cart">Giỏ hàng</a></div>
            </div>
            <div class="col-lg-4 col-6">
                <h6>Hỗ trợ</h6>
                <div>Hotline: 1900 0000</div>
                <div>Email: shop@doan.edu.vn</div>
                <div>Giao hàng toàn quốc — Freeship từ 500K</div>
            </div>
        </div>
        <div class="footer-bottom text-center">
            Đồ án môn Lập trình Web &copy; 2026 — Nhóm sinh viên
        </div>
    </div>
</footer>
