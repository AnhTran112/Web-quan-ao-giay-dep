...
<nav class="navbar navbar-expand-lg site-nav">
    <div class="container">
        <a class="navbar-brand fw-bold" href="${pageContext.request.contextPath}/home">Shoe<span class="brand-dot">Shop</span></a>
        ...
        <div class="collapse navbar-collapse" id="mainNav">
            ...
            <a href="${pageContext.request.contextPath}/cart" class="btn-cart mt-2 mt-lg-0 position-relative">
                Giỏ hàng
