...
(1, 'Giày Sneaker Cổ Cao',       'Sneaker cổ cao streetwear.',                  520000,  'giay sneake co cao.jpg', 35, 10),
(1, 'Giày Bóng Rổ Jumper',       'Giày bóng rổ ôm cổ chân, đế bám sân.',        890000,  'giay bong ro.jpg',       18, 15),
(1, 'Giày Tennis Ace',           'Giày tennis chuyên dụng.',                    720000,  'giay tenis ace.jpg', 22, 0),
(1, 'Giày Đi Bộ EasyWalk',       'Giày đi bộ siêu nhẹ.',                        380000,  'giay chay bo.jpg',       45, 5),
(2, 'Giày Tây Đen Oxford',       'Giày da nam Oxford màu đen lịch sự.',         800000,  'giay oxford.jpg',  20, 10),
(2, 'Giày Tây Nâu Derby',        'Giày Derby da bò màu nâu.',                   850000,  'giay tay derby.jpg',  15, 0),
(2, 'Giày Lười Da Loafer',       'Giày lười da mềm, xỏ nhanh tiện lợi.',        690000,  'giay loafer.jpg',  25, 20),
(2, 'Giày Boot Da Chelsea',      'Boot Chelsea cổ chun, da bóng cao cấp.',      1200000, 'giay chels.jpg',  10, 0),
(3, 'Sandal Quai Ngang',         'Sandal quai ngang khóa dán, đế PU nhẹ.',      250000,  'sandal quai ngang.jpg',       40, 0),
(3, 'Dép Quai Hậu Thể Thao',     'Dép quai hậu thể thao năng động.',            180000,  'dep quai hau.jpg',       55, 10),
(3, 'Dép Sục Nhựa EVA',          'Dép sục nhựa EVA siêu nhẹ, dễ vệ sinh.',      120000,  'dep suc Eva.jpg', 0,  0),
(4, 'Áo Thun Basic Cotton',      'Áo thun cổ tròn nhiều màu, cotton 100%.',     150000,  'o thun basic.jpg',       120, 0),
(4, 'Áo Thun Oversize Street',   'Áo thun oversize form rộng.',                 190000,  'ao thun oversize.jpg',       80, 15),
(4, 'Áo Thun Thể Thao Coolmax',  'Áo thun thể thao vải Coolmax thấm mồ hôi.',   220000,  'ao thun the thao.jpg',       60, 0),
(4, 'Áo Thun In Graphic',        'Áo thun in hình graphic cá tính.',            175000,  'ao thun graphic.jpg',       70, 20),
(5, 'Áo Polo Classic',           'Áo polo cổ bẻ trẻ trung, form regular.',      250000,  'polo clasic.jpg',       60, 15),
(5, 'Áo Polo Thể Thao',          'Áo polo vải cá sấu co giãn 4 chiều.',         280000,  'ao polo the thao.jpg',       45, 0),
(5, 'Áo Sơ Mi Trắng Công Sở',    'Sơ mi trắng dài tay chống nhăn.',             320000,  'ao so mi trang.jpg',       50, 10),
(5, 'Áo Sơ Mi Flannel Caro',     'Sơ mi flannel caro dày dặn.',                 350000,  'ao so mi.jpg',       30, 0),
(6, 'Áo Khoác Gió Nam',          'Áo khoác gió 2 lớp chống nước nhẹ.',          420000,  'gio nam.jpg',       35, 25),
(6, 'Áo Khoác Jean Denim',       'Áo khoác jean denim wash nhẹ.',               480000,  'denim.jpg',     25, 0),
(6, 'Áo Hoodie Nỉ',              'Hoodie nỉ bông dày ấm, mũ 2 lớp.',            390000,  'hoddie.jpg',       40, 10),
(7, 'Quần Jean Slimfit',         'Quần jean ôm dáng thể thao.',                 350000,  'jean nam slimfit.jpg',     40, 0),
(7, 'Quần Jean Baggy',           'Quần jean baggy ống rộng, phong cách retro.', 380000,  'quan jean baggy.jpg',     35, 15),
(7, 'Quần Jean Rách Gối',        'Quần jean rách gối bụi bặm.',                 400000,  'uan jean rach goi.jpg',     28, 0),
(8, 'Quần Kaki Ống Đứng',        'Quần kaki ống đứng lịch sự.',                 320000,  'quan kaki ong dung.webp',     45, 10),
(8, 'Quần Short Kaki',           'Quần short kaki trên gối, trẻ trung.',        220000,  'quan short kaki.webp',     65, 0),
(8, 'Quần Jogger Thể Thao',      'Quần jogger bo gấu, vải thun co giãn.',       260000,  'jogger.jpg',       55, 20);
